/*Problema a resolver: determinar si un numero X pude formarse usando la suma de 2 elementos de un array*/
...
/*Especificaciones:
    ...
    Para la construccion del ejercicio se uso como lenguaje JavaScript,
    Node Js como entorno de ejecucion y prettier para dar formato al codigo.

    Como plus me parecia interesante agregar un "profiling" para analizar el rendimiento de los algoritmos. Para esto use el metodo "performance.now()".
*/
